...
def go(args):
    ...
    logger.info(f"Getting artifact ({args.trainval_artifact}) from W&B")
    ...
    logger.info("Exporting model in sklearn format")
    ...
    artifact = wandb.Artifact(
        ...
        type="model_export",
        description="Random Forest Pipeline model export",
        metadata=rf_config,
    )
