#!/usr/bin/env python
"""
Performs basic cleaning on the data and saves the clean data in Weights and Biases
"""
import argparse
import logging
import wandb
...
def go(args):
    ...
    logger.info(f"Getting {args.input_artifact} from W&B")
    ...
    logger.info("Creating W&B artifact and adding clean_sample.csv.")
